...
const labels = {
  en: {
    ...
    ctaBody: "Dr. Dan Foss offers a free evaluation at Pura Vida Chiropractic in San Antonio.",
  ...
  es: {
    ...
    ctaBody: "El Dr. Dan Foss ofrece una evaluación gratuita en Pura Vida Quiropráctica en San Antonio.",
