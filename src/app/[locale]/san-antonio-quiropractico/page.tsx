...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: isEs
      ? "Quiropráctico Hispano San Antonio TX (En Español) ★ 159 Reseñas | Pura Vida"
      : "San Antonio Chiropractor in Spanish — 159 Five-Star Reviews | Pura Vida",
    description: isEs
      ? "¿Busca un quiropráctico que hable español en San Antonio? Dr. Dan Foss — bilingüe, certificación SOT Avanzada, 23+ años atendiendo familias hispanas. Evaluación gratis. 4.8★ con 159 reseñas. (210) 685-1994."
      : "Spanish-speaking chiropractor in San Antonio, TX. Dr. Dan Foss DC — bilingual EN/ES, Advanced SOT certification, 23+ years serving the Hispanic community. Free evaluation. 4.8★ with 159 reviews. (210) 685-1994.",
    alternates: {
      canonical,
      languages: {
...
const faqs = [
  ...
  {
    es: { q: "¿Aceptan seguros médicos en San Antonio?", a: "Somos insurance friendly. Traiga su tarjeta de seguro e ID a la oficina para verificar cómo su seguro puede contribuir a su cuidado. También ofrecemos planes de pago para quienes no tienen seguro o cuya cobertura es limitada." },
    en: { q: "Do you accept insurance in San Antonio?", a: "We are insurance friendly. Bring your insurance card and ID to the office to verify how your insurance can contribute to your care. We also offer payment plans for those without insurance or with limited coverage." },
  },
  {
