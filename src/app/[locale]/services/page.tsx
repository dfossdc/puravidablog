      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Dr. Dan Foss adjusting a patient at Pura Vida Chiropractic San Antonio",
        },
      ],
    },
    twitter: {
...
const serviceList = {
  en: [
    ...
    { slug: "pediatric-prenatal", label: "Pediatric & Prenatal Combined" },
  ...
  es: [
    ...
    { slug: "quiropractica-pediatrica", label: "Pediátrica y Prenatal Combinada" },
