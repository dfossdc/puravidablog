...
const socialLinks = [
  { name: "Facebook", href: "https://www.facebook.com/puravidasanantonio/", label: "f" },
  { name: "Instagram", href: "https://www.instagram.com/puravidasatx/", label: "ig" },
  { name: "YouTube", href: "https://www.youtube.com/@puravidasanantonio", label: "yt" },
  { name: "Yelp", href: "https://www.yelp.com/biz/pura-vida-chiropractic-san-antonio", label: "y" },
];
      ...
      <div className={styles.inner}>
        <div className={styles.col}>
          ...
          <div className={styles.social}>
            <p className={styles.socialLabel}>{t.followUs}</p>
...
with open("src/components/Footer.tsx", "w", encoding="utf-8") as f:
    f.write(content)
print("Footer.tsx written successfully!")