...
1. **The spine and pelvis**, using pelvic blocks and neurological indicators.
2. **The organs**, through Chiropractic Manipulative Reflex Technique (CMRT).
3. **The cranium**, through SOT Craniopathy.
...
1. **Intake and health history** — we learn your story.
2. **Physical and neurological exam** — including SOT indicators.
3. **X-rays if clinically indicated.**
4. **Report of findings** — Dr. Foss explains what he found, what category you are in, and what the plan is.
5. **Your first adjustment** — specific to your findings today.
...
*Hablamos español. Nuestra clínica es bilingüe.*
