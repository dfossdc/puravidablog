...
Radiculopathy (a pinched nerve) causes pain, numbness, tingling, or weakness radiating along a nerve path. This creates significant disability and suffering.
...
At Pura Vida Chiropractic, Dr. Dan Foss, DC specializes in identifying and correcting the spinal misalignments causing radiculopathy. He uses advanced SOT and CMRT techniques.
...
**Cervical Radiculopathy**: Pain, numbness, or tingling in the neck, shoulder, arm, or hand. Symptoms depend on which cervical nerve root is affected (C5, C6, C7, or C8).

**Thoracic Radiculopathy**: Pain or burning along the ribs or chest wall, often mistaken for heart problems. Thoracic radiculopathy is less common but can cause significant disability.

**Lumbar Radiculopathy**: Pain, numbness, or weakness in the lower back, buttocks, leg, or foot. Lumbar radiculopathy affecting the S1 nerve root (often called sciatica) is the most common form.

## Common Causes of Radiculopathy

**Disc Herniation**: When an intervertebral disc's inner material extrudes through its outer annulus, it can directly compress an adjacent nerve root, causing radiculopathy. This is particularly common in the lumbar and cervical spine.

**Spinal Stenosis**: Degenerative changes in the spine can narrow the spaces through which nerve roots exit (the intervertebral foramen—the openings nerves pass through), compressing nerves and producing radiculopathy symptoms.

**Vertebral Subluxations** (spinal misalignments): Misalignments of vertebral bodies can narrow the neural foramen and create abnormal pressure on nerve roots. Often, correcting these subluxations relieves radiculopathy without addressing disc material.

**Facet Joint Dysfunction**: The small joints between vertebrae (facet joints) can become misaligned, inflamed, or develop bone spurs. These can compress adjacent nerve roots.

**Nerve Root Inflammation**: Even without physical compression, nerve root inflammation from mechanical stress or chemical irritation can produce radiculopathy symptoms.
...
The key to his success is that he doesn't simply mask radiculopathy pain. He corrects the underlying biomechanical problem causing nerve root compression. By restoring proper spinal alignment and removing the mechanical pressure on the nerve root, he allows healing to occur and symptoms to resolve permanently.
...
SOT Category II cranial adjustments enhance brain stem function. They improve cerebrospinal fluid (the cushioning fluid around the brain and spine) circulation, supporting the central nervous system's ability to modulate pain and control inflammation. This cranial component often dramatically accelerates radiculopathy recovery.
...
CMRT produces rapid improvements in radiculopathy symptoms. Many patients experience significant pain reduction within days of beginning care, demonstrating the technique's effectiveness at addressing inflammation from nerve root compression.

## Class IV Laser Therapy for Nerve Healing

Class IV laser therapy penetrates deep into tissues surrounding the affected nerve root. It reduces inflammation and stimulates cellular healing. The laser's energy enhances mitochondrial function in nerve cells, promoting regeneration of damaged nerve fibers and restoration of normal nerve function.

Laser therapy is particularly valuable for chronic radiculopathy. Prolonged nerve compression can cause degenerative changes in nerve fibers. By promoting nerve cell regeneration, laser therapy supports functional recovery.
...
This evaluation determines exactly which nerve root is affected and what's causing the compression.
...
Car accidents, falls, sports injuries, or lifting accidents can immediately create subluxations (spinal misalignments) and disc herniation causing acute radiculopathy.
...
- Intractable pain unresponsive to 12 or more weeks of aggressive conservative care
- Rapidly progressive neurological decline

Dr. Foss is experienced at determining when surgery should be considered. He will refer you to an appropriate surgeon if your case requires surgical management.
