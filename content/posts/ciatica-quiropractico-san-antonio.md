...
La ciática describe el dolor que sigue el camino del nervio ciático — el nervio más largo del cuerpo, que va desde la parte baja de la espalda hacia los glúteos y baja por cada pierna.

Las causas más comunes incluyen:

- **Hernia de disco** — un disco abultado que presiona la raíz del nervio ciático
- **Síndrome del piriforme** — tensión en el músculo piriforme
- **Estenosis espinal** — estrechamiento del canal espinal
- **Disfunción de la articulación sacroilíaca** — desalineación del SI
- **Enfermedad degenerativa del disco**
- **Espondilolistesis** — una vértebra que se desliza hacia adelante

## Por Qué la Quiropráctica Es Uno de los Tratamientos Más Efectivos

El Dr. Foss utiliza la **[Técnica Sacro-Occipital (SOT)](/es/services/quiropractica-sot)** para abordar los desequilibrios pélvicos y lumbares que causan la ciática, combinada con [terapia SoftWave](/es/services/terapia-softwave) y [láser Clase IV](/es/services/laser-clase-iv) para acelerar la curación nerviosa.
